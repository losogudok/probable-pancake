...
// Примечание: разделы «Граф» и «Источники» заморожены до появления соответствующих
// эндпоинтов в API-контракте (см. API.md — §2 subgraph требует doc_ids, §нет для
// entity-поиска/загрузки документов). Файлы компонентов сохранены под `@ts-nocheck`.
